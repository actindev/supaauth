        ...
        <div className="flex flex-col h-full p-6">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Netlify Deploy Button in Mobile Menu */}
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 px-4 py-2 mt-2 rounded-md font-medium text-white bg-[#00AD9F] border border-[#00AD9F]/30 hover:bg-[#00C7B7] transition-colors duration-200"
        ...
        <div className="w-full h-full flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium bg-[#00AD9F] border border-[#00AD9F]/30 hover:bg-[#00C7B7] transition-colors duration-200 text-white"
              aria-label="Deploy to Netlify"
            >
